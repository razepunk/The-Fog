...
public class theFog {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (!direction1.equalsIgnoreCase("LEFT") && !direction1.equalsIgnoreCase("Right")) {
        ...
        if (direction1.equalsIgnoreCase("Left")) {
            ...
            JOptionPane.showMessageDialog(null, "Knocking some mud off your boots you enter\n" +
            ...
            for (int i = 0; i < 2; i++) {
                ...
                JOptionPane.showMessageDialog(null, "You are seeking the crystal of time are you not?");
            ...
            if (attack.equalsIgnoreCase("Cast")){
                ...
                if (weapon1.equalsIgnoreCase("Axe")){
                    ...
                    JOptionPane.showMessageDialog(null, "Slashing with the sword you make contact\n" +
                            "with his hands he then drops his sword.");
            ...
            if (attack.equalsIgnoreCase("Cast")){
                ...
                if (element.equalsIgnoreCase("Earth")){
                    ...
                    JOptionPane.showMessageDialog(null, "Casting again a flame licks the man burning him to a crisp.");
                }
                else if (element.equalsIgnoreCase("Water")){
                    ...
                    JOptionPane.showMessageDialog(null, "The man coughs and blood trickles down his leg.\n" +
                            "The man has been impaled on a branch of a tree.");
                }
