...
public class theFog {
    ...
    JOptionPane.showMessageDialog(null, "Hi " + capName + ". Welcome to The Fog!", "The Fog", JOptionPane.INFORMATION_MESSAGE, icon1);
    ...
    if (weapon1.equalsIgnoreCase("Axe")) {
        ...
        URL url3 = theFog.class.getClassLoader().getResource("sword.wav");
